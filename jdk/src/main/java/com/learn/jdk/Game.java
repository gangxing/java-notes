...
public class Game {
    ...
    class Move {
        ...
        Direction directionX=Direction.DESCREASE;
        Direction directionY=Direction.DESCREASE;
        ...
        void randomX() {
            ...
            boolean increase = Direction.INCREASE==directionX;
            int newx;
            int d = 2 * ball.radius;
            if (increase) {
                ...
                if (c > 0) {
                    ...
                    canvas.repaint();
                    newx = 500 - d - c;
                    directionX=Direction.DESCREASE;
                }
            } else {
                newx = ball.x - xincrease;
                int c = newx;
        ...
        void randomY() {
            Random random = new Random();
            int xincrease = minStep + random.nextInt(maxStep - minStep);
            boolean increase = Direction.INCREASE==directionY;
            int newy;
            int d = 2 * ball.radius;
            if (increase) {
                ...
                if (c > 0) {
                    ...
                    canvas.repaint();
                    newy = 500 - d - c;
                    directionY=Direction.DESCREASE;
                }
            } else {
                newy = ball.y - xincrease;
                int c = newy - d;
